...
namespace BOOPM3_01_07
{
    ...
    //Excercises:
    //1.    Create an expression bodied method Sum (Rectangle r) that takes a Rectange as an argument and return the sum of the Areas
    //      of the object instance and the argument.
    //2.    Create an expression bodied method Equal (...) that returns true if two reactangles are equal.
    //3     Implement Equal (...) as a static Method as well as a non-static Method. Have one call the other as part of its implementation. 
}
